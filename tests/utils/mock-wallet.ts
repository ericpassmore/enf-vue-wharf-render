...
import {mockChainDefinition, littleBrotherMockPermissionLevel, mockPrivateKey} from './mock-config'
...
export class MockWalletPluginConfigs extends AbstractWalletPlugin {
    ...
    async login(context: LoginContext) {
        ...
        return {
            ...
            permissionLevel: context.permissionLevel || PermissionLevel.from(littleBrotherMockPermissionLevel),
        }
    }
    async sign(
